...
Open `index.html`. That's it. That's the whole museum.

## The Almanac

The building's complete record — blueprints, lighting schedule, the painting
recipes, the incident report for the door that wouldn't open, and the
attribution veil — lives in [ALMANAC.md](ALMANAC.md).

---

*Raised in concert for the Codex Project Builder · MMXXVI*
